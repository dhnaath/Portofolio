      ...
      <nav className="w-full px-[10pt] py-8 max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-around gap-6 md:gap-0">
          ...
          >
            ...
            <span className={`text-sm font-serif max-w-[320px] text-center transition-colors ${activeSection === "experience" ? "text-gray-800" : "text-gray-500 group-hover:text-gray-700"}`}>Professional Journey, Career Path,<br />and Strategic Contributions</span>
          </button>
          <button
          ...
          >
            ...
            <span className={`text-sm font-serif max-w-[320px] text-center transition-colors ${activeSection === "akademik" ? "text-gray-800" : "text-gray-500 group-hover:text-gray-700"}`}>Thesis, Publications, Research Planning,<br />Projects, Seminars, and Transcripts</span>
          </button>
          <button
          ...
          >
            ...
            <span className={`text-sm font-serif max-w-[320px] text-center transition-colors ${activeSection === "proyek" ? "text-gray-800" : "text-gray-500 group-hover:text-gray-700"}`}>Certifications, Licenses, Memberships, Competencies, Skills, and Achievements.</span>
          </button>
        </div>
      </nav>
    </header>
