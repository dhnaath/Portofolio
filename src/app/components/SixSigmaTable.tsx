...
const topics: Topic[] = [
  ...
  { 
    no: 2, 
    materi: "Six Sigma History and Application", 
    items: [
  ...
  { 
    no: 3, 
    materi: "Other Process Improvement and Quality Methods", 
    items: [
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#E4E2DC] border-b border-[#5B6572]/30 text-sm md:text-base font-serif">
              ...
              <th className="py-4 px-4 font-semibold">Body of Knowledge</th>
            </tr>
          </thead>
          <tbody>
                  ...
                  {isExpanded && topic.items && topic.items.length > 0 && (
                    <tr className="bg-[#F9F9F8] border-b border-[#5B6572]/20">
                      ...
                      <td className="py-3 px-4">
                        <ul className="list-disc list-inside space-y-1.5 font-cambria text-sm md:text-base text-[#5B6572] py-2">
                          {topic.items.map((item, idx) => (
                            <li key={idx} className="hover:text-[#222222] transition-colors">{item}</li>
                          ))}
                        </ul>
                      </td>
                    </tr>
            ...
            {paginatedTopics.length === 0 && (
              <tr>
                <td colSpan={2} className="py-8 text-center text-[#5B6572] font-cambria">
                  Tidak ada data.
                </td>
              </tr>
            )}
